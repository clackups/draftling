 ...
 * would otherwise keep scanning and draining the pack.
 *
 * On non-GT911 backends and on the no-touchscreen build this is
 * a no-op so callers don't need conditional compilation. */
